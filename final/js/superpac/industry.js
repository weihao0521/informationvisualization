(function () {
    ...
    var svg = d3.select("#industryDiv").append("svg")
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom)
        .append("g")
        .attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    d3.tsv("../../data/industry/" + candidate + "_Industry.tsv", type, function (error, data) {
        ...
        svg.selectAll(".bar")
            ...
            .style("fill", function (d) {
                return party == "rep" ? color_red(d.Industry) : color_blue(d.Industry);
            });
    });
